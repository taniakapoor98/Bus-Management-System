...
<%@page import="newpackage.Bus_sch"%>
...
<body class="index-page sidebar-collapse">
        <div class="page-header clear-filter" filter-color="orange">
                ...
                <div class="page-header-image" data-parallax="true" style="background-image:url('./myproject/assets/img/bg11.jpg');  background-repeat: no-repeat; background-size: cover; "></div>
                
                <div class="container">
                        
                          
                          <h1 class="h1-seo" style="margin: 0 auto;">CHANGE ROUTES</h1>
                         
                <div>
                    <ul id="hl">
                        <li>
                            <div class="routes" style="align-self: center;z-index: 1000;">
                                    <img class="rounded-circle img-raised" src="./myproject/assets/img/1.jpg" alt="">
                                    <div style="z-index:1000; position: absolute;top:48%;left:27%;color:rgb(4, 4, 68);font-size: 20px; transform: translate(-50%, -50%);">
                                     Mohali
                                    </div>
                            </div>
                        ...
                        <li>
                                <div class="routes" style="align-self: center;z-index: 1000;">
                                        <img class="rounded-circle img-raised" src="./myproject/assets/img/1.jpg" alt="">
                                        <div style="z-index:1000; position: absolute;top:48%;left:50%;color:rgb(4, 4, 68);font-size: 20px; transform: translate(-50%, -50%);">Chandigarh</div>
                                </div>
                            ...
                            <li>
                                    <div class="routes" style="align-self: center;z-index: 1000;">
                                            <img class="rounded-circle img-raised" src="./myproject/assets/img/1.jpg" alt="">
                                            <div style="z-index:1000; position: absolute;top:48%; left:73%;color:rgb(4, 4, 68);font-size: 20px; transform: translate(-50%, -50%);">Panchkula</div>
                                    </div>
                ...
                <div id="view_table">
                    ...
                    <!-- <button id="ajax_btn">Mohali</button> -->
                  <table class="table" >
                    <thead>
                      <tr>
                        <th>S.no.</th>
                    ...
                    %>
                      <tr>
                        ...
                        <td><%=i.getRoute()%></td>
                        <td>
                                <a  data-toggle="modal" href="#my_mod5" onclick="change('<%=i.getId()%>')">
                                    <button type="button" style="border-radius: 20px;background-color: pink;box-shadow: none;" >Change</button></a></td>
                      </tr>
                      <%
                        }
  ...
  <!--nav ends-->
   <!-- modal for change.jsp -->
      <div class="modal fade" style="background-blend-mode: luminosity;" id="my_mod5" role="dialog">
        
            <div class="modal-dialog" >
               
              <!-- Modal content-->
              <div class="modal-content"style="background-color:whitesmoke; opacity:.99;">
                ...
                <div >
                        ...
                        <form id="change" class="form" method="get" action="Change">
                            <div class=" text-center">
                               
                              <h3 class="card-title title-up" style="color:black">Update</h3>
                              
                            </div>
                             <div class="input-group no-border">
                                 
                               <select class="input-group no-border" name="field" default="Select field">
                                   <option value="select">--Select field--</option>
                                    <option value="bus_no">Bus no.</option>
                                    <option value="route_no">Route no.</option>
                                    <option value="dname">Driver's name</option>
                              ...
                              <div class="input-group no-border">
                                ...
                                <input type="text" name="new_val" placeholder="Enter new value" class="form-control" required/>
                              </div>
                            

                              </div>
                            </div>
              <input  type="text" name="coll" value="0" hidden/>
                            <div class="card-footer text-center" style="background-color:rgb(191, 228, 243);">
                              <input type="submit" value="update"  class="btn btn-neutral btn-round btn-lg"  />
   ...
   <div class="modal fade" style="background-blend-mode: luminosity;" id="my_mod2" role="dialog">
    ...
    <script>
      ...
      function change(p)
      {
          document.forms['change']['coll'].value=p;
          document.getElementById("coll").value=p;                           
      }
