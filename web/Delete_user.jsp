...
<body class="index-page sidebar-collapse">
        <div class="page-header clear-filter" filter-color="orange">
                ...
                <div class="container">
                          ...
                          <h1 class="h1-seo" style="margin: 0 auto;">DELETE USER </h1>
                  ...
                  <table class="table" >
                    ...
                    %>
                      <tr>
                        ...
                        <td><a href="Delete_user?id=<%=i.getId() %>">
                                <button type="button" class=" btn" style="height:24px;width:80px;padding:0;" >Delete</button></a></td>
                      </tr>
                      <%
                        }
