...
<body class="index-page sidebar-collapse">
        <div class="page-header clear-filter" filter-color="orange">
                ...
                <div class="page-header-image" data-parallax="true" style="background-image:url('./myproject/assets/img/bg8.jpg'); background-size: cover;"></div>
                
                <div class="container">
                        
                          
                          <h1 class="h1-seo" style="margin: 0 auto;">VIEW ROUTES</h1>
                ...
                <div id="view_table">
                    <button class="btn" id="ajax_btn">Show Table</button>
                  <table class="table" >
                    <thead>
                      <tr>
                        <th>S.no.</th>
  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
      <span class="open-slide">
        ...
        <div id="side-menu" class="side-nav">
          ...
          <a href="file:///F:/New%20folder/html/html_project/myproject/my.html">Home</a>
          <a href="file:///F:/New%20folder/html/html_project/myproject/about.html">About</a>
          <a href="file:///F:/New%20folder/html/html_project/myproject/services.html#">Services</a>
          <a href="file:///F:/New%20folder/html/html_project/myproject/contact.html#">Contact</a>
        </div>
    ...
    <div class="container">
      <div class="navbar-translate">
        ...
        <a class="navbar-brand" href="file:///F:/New%20folder/html/html_project/myproject/about.html" rel="tooltip"  data-placement="bottom" target="_blank" style="font-size: 15px;">
           About Us
        </a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
              <a class="dropdown-item" target="_top" href="file:///F:/New%20folder/html/html_project/myproject/mohali.html#">
                <i class="now-ui-icons design_bullet-list-67"></i> Mohali
              </a>
              <a class="dropdown-item" target="_top" href="file:///F:/New%20folder/html/html_project/myproject/pkl.html">
                <i class="now-ui-icons design_bullet-list-67"></i> Punchkula
              </a>
              <a class="dropdown-item" target="_blank" href="file:///F:/New%20folder/html/html_project/myproject/chd.html" target="_top">
  ...
  <!--nav ends-->
   ...
   <div class="modal fade" style="background-blend-mode: luminosity;" id="my_mod2" role="dialog">
    ...
    <script type="text/javascript" src=".\myproject\assets\js\json.js"></script>
    <script>
